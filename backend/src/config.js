...
const namePrefix = "Big Ted";
const description = "In a far away land, the one true Big Ted appeared. From him came Water, Earth, Wind and Fire. He now has 4096 sons and daughters, each of them unique. Although all are special, he has his favourites...";
const baseUri = "ipfs://NewUriToReplace"; // This will be replaced automatically

// If you have selected Solana then the collection starts from 0 automatically
const layerConfigurations = [
  {
    growEditionSizeTo: 4096,
    layersOrder: [
      { name: "Background" },
      { name: "Body" },
      { name: "Head" },
...
const extraMetadata = {
  external_url: "https://bigted.xyz", // Replace with your website or remove this line if you do not have one.
};
